...
class SagemakerStudioStack(core.Stack):
	...
	def __init__(self, scope: core.Construct, construct_id: str,
		...
		role_sagemaker_studio_domain = iam.Role(self, 'SagemakerStudioUserProfileRole',
		                                        assumed_by=iam.ServicePrincipal('sagemaker.amazonaws.com'),
		                                        role_name="SagemakerStudioUserProfileRole",
		                                        managed_policies=[
		...
		self.sagemaker_domain_name = "SagemakerStudioMissionDomain"
		...
		team_to_add_in_sagemaker_studio = ["anta-profile", "lancelot-profile"]
